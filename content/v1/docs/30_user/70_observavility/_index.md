...
Custom logs can be added from the nodes using the `logger` included in the [context]({{< relref "docs/30_user/60_kais_runner_sdk/#context" >}}) object.
...
has its own influx bucket, to which the nodes can save metrics through the [context]({{< relref "docs/30_user/60_kais_runner_sdk/#context" >}}) object.
